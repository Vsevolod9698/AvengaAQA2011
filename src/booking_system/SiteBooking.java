...
public class SiteBooking implements ISearch {
    ...
    public List<IHotel> search(int stars) {
        List suitableHotels= new ArrayList<>();
    ...
    public List<IHotel> searchByFreeRooms(String room) {
        List freeRoom = new ArrayList<>();
        for (IHotel hotel: Hotel.values()){
            if (hotel.getFreeRooms().equals(room)){
                freeRoom.add(hotel);
    ...
    public ArrayList<Hotel> searchByTypeOFRooms(String type) {
        ArrayList typeRoom = new ArrayList<>();

        for (IHotel hotel: Hotel.values()){
            if (hotel.getTypeRooms().equals(type)){
    ...
    public List<Hotel> searchByTimeSettlement(String time) {
        ArrayList timeSettlement = new ArrayList<>();
        for (IHotel hotel: Hotel.values()){
        ...
        DateTimeFormatter fff = DateTimeFormatter.ofPattern("d MMMM, YYYY");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(timeSettlement.searchByTimeSettlement("d MMMM, YYYY"));
